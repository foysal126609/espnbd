                        ...
                        <tr>
                            ...
                            <td>
                                @if($allCategoryInfo->publication_status== 1)
                                    <a href="{{url('/category/unpublished/'.$allCategoryInfo->id)}}" class="btn btn-success btn-xs" title="Published blog">
                                        <span class="glyphicon glyphicon-arrow-up"></span>
                                    </a>
                                @else
                                    <a href="{{url('/category/published/'.$allCategoryInfo->id)}}" class="btn btn-warning btn-xs" title="UnPublished blog">
                                        <span class="glyphicon glyphicon-arrow-down"></span>
                                    </a>
                                @endif

                                <a href="{{url('/category/edit/'.$allCategoryInfo->id)}}" class="btn btn-primary btn-xs" title="Edit blog">
